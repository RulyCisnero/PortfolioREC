                ...
                <div className='fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90'>
                    <div className='bg-gray-900 rounded-xl shadow-2xl lg:w-full w-[90%] max-w-3xl overflow-hidden relative'>
                        ...
                        <div className='flex flex-col items-center'>
                            <div className='w-9/12 flex items-center justify-center bg-gray-900 px-4'>
                            ...
                            <div className='lg:p-8 p-6'>
                                ...
                                <div className='flex gap-4 justify-center'>
                                    <a href={selectedProject.github} target='_blank' rel='nose referencia' className='w-1/2 bg-gray-800 hover:bg-purple-800 text-gray-400 justify-center lg:px-6 lg:py-2 px-2 py-1 rounded-xl lg:text-xl text-sm font-semibold text-center'>View Code
                                    </a>
                                </div>
                            </div>
